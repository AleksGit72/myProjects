...
# Программа выводит те же строки, но удаляет комментарии и символы пустого пространства(пробе) в конце строк. Пустую строку вместо первой строки ввода выводить не надо(#...).
n, text = input(), []
n=int(n[1:])
for x in range(n) :
    x = input()
