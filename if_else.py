"""
  Выражение  	Описание
if var > 7	если var больше 7
if var < 7	если var меньше 7
if var >= 7	если var больше либо равен  7
if var <= 7	если var меньше либо равен  7
if var == 7	если var равен  7
if var != 7	если var не равен  7
"""
"""
num1 = int(input('num1 = '))
num2 = int(input('num2 = '))
